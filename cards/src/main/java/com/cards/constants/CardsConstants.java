...
public class CardsConstants {
    ...
    public static final String CARD_ALREADY_EXISTS_TITLE = "customer.already.exists-title";
    public static final String CARD_ALREADY_EXISTS_DETAIL = "customer.already.exists-detail";
}
