...
public class LoansConstants {
    ...
    public static final String  MESSAGE_417_UPDATE= "Update operation failed. Please try again or contact Dev team"; // TODO - INTERNATIONALIZATION
    public static final String  MESSAGE_417_DELETE= "Delete operation failed. Please try again or contact Dev team"; // TODO - INTERNATIONALIZATION
}
